...
#define pt_free(_target) pt_free_impl((_target), __FILE__, __LINE__, __func__)

pt_error pt_malloc_impl(
  void** target, const size_t size, const char* file, const int line,
  const char* function);
#define pt_malloc(_target, _size) \
  pt_malloc_impl((_target), (_size), __FILE__, __LINE__, __func__)
...
#define pt_calloc(_target, _n, _size) \
  pt_calloc_impl((_target), (_n), (_size), __FILE__, __LINE__, __func__)

pt_error pt_realloc_impl(
  void** target, const size_t size, const char* file, const int line,
  const char* function);
#define pt_realloc(_target, _size) \
  pt_realloc_impl((_target), (_size), __FILE__, __LINE__, __func__)
...
#define pt_aligned_alloc(_target, _alignment, _size) \
  pt_aligned_alloc_impl( \
    (_target), (_alignment), (_size), __FILE__, __LINE__, __func__)
...
#define pt_aligned_realloc(_target, _input, _alignment, _size, _size_prev) \
  pt_aligned_realloc_impl( \
    (_target), (_input), (_alignment), (_size), (_size_prev), __FILE__, \
    __LINE__, __func__)
