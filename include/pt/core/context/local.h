...
pt_status pt_release_context_local(pt_context_local target);
pt_status pt_initialize_context_local(pt_context_local target);
pt_status pt_finalize_context_local(pt_context_local target);
